-- Columna de puntos extra por dinámicas/actividades.
-- Completamente separada de puntos_adicionales.
-- Se suma directamente al puntaje principal de la quiniela.

alter table perfiles
  add column if not exists puntos_extra int not null default 0;

-- Vista actualizada: suma puntos_extra al total de partidos
